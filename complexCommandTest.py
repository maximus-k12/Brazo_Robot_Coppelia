...
clientID=sim.simxStart('127.0.0.1',19999,True,True,5000,5) # Conéctese a CoppeliaSim
if clientID!=-1:
    print ('Connected to remote API server')

    # 1. Primero envíe un comando para mostrar un mensaje específico en un cuadro de diálogo:
    emptyBuff = bytearray()
